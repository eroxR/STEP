<div>
    ...
    <!--Modal Permit -->
        ...
        @include('livewire.list.sections.modalContract-permit')

    <!--end Modal Permit -->

    <!--Modal Firma Contrato -->

        @include('livewire.list.sections.modalContract-document')

    <!--end Firma Contrato -->

    <!--Modal Fuec -->

        @include('livewire.list.sections.modalContract-fuec')
...
@section('scripts')
    <script>
        ...
        Livewire.on('disable', () => {
            ...
            $(".car").val(null).trigger('change');
            $(".select2").prop("disabled", false);
            $(".car").prop("disabled", false);
            viewhideinputs('chooseDrivers', 'Inactive', 'Active');
            viewhideinputs('chooseVehicles', 'Inactive', 'Active');
            viewhideinputs('btnGenerate', 'Inactive', 'Active');
        ...
        Livewire.on('crud', (contractnumber, process, contractType, id, permit_number, contingency) => {
            ...
            var contingency = contingency.contingency[0];
            var main = '';
            var message = '';
