<div>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="roundedx1 mt5 mr3 fixed inset-y-0 flex items-end bg-black bg-opacity-50 sm:items-center">
                <input id="input"
                    ...
                    type="text" placeholder="Buscar X Nombre" wire:model="search">
                                    ...
                                    <div
                                        ...
                                        <div class="grid grid-cols-5 gap-4">
                                            ...
                                            <div class="border-b text-black text80 dark:text-white ">
                                                <strong class="dark:text-yellow-400">Expedida:</strong> falta
                                                agregar
                                                este campo <br>
                                            ...
                                            <div class="border-b text-black text80 dark:text-white ">
                                                <strong class="dark:text-yellow-400">Dirección de
                                                    residencia:</strong>
                                                {{ $driver->address }} <br>
                                            ...
                                            @foreach ($beneficiaries as $beneficiary)
                                                @if ($beneficiary->user_id == $driver->user_id)
                                                    <div class="border-b text-black text80 dark:text-white ">
                                                        ...
                                                        <strong class="dark:text-yellow-400">Nombre
                                                            Completo:</strong>
                                                        <br>
                                            ...
                                            <div class="border-b text-black text80 dark:text-white ">
                                                ...
                                                <span
                                                    ...
                                                    @if (!$driver->certificate_drugs_alchoolemia)
                                                        Sin información
                                                    @else
                                                        {{ $driver->certificate_drugs_alchoolemia }}
                                                    @endif
                                                </span>
                                                <br>
                                            ...
                                            <div class="border-b text-black text80 dark:text-white ">
                                                ...
                                                <br>
                                                <strong class="dark:text-yellow-400">Antecedentes
                                                    Contraloria:</strong>
                                                <br>
                                                <span
                                                    class=" @if ($driver->comptroller_record < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                    @if (!$driver->comptroller_record)
                                                        Sin información
                                                    @else
                                                        {{ $driver->comptroller_record }}
                                                    @endif
                                                </span>

                                                <br>
                                                <strong class="dark:text-yellow-400">Antecedentes Policia:</strong>
                                                <br>
                                                <span
                                                    class=" @if ($driver->police_record < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                    @if (!$driver->police_record)
                                                        Sin información
                                                    @else
                                                        {{ $driver->police_record }}
                                                    @endif
                                                </span>
                                                ...
                                                <br>
                                                <span
                                                    class=" @if ($driver->attorney_record < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                    @if (!$driver->attorney_record)
                                                        Sin información
                                                    @else
                                                        {{ $driver->attorney_record }}
                                                    @endif
                                                </span>
                                            ...
                                            <div class="border-b text-black text80 dark:text-white">
                                                ...
                                                <strong class="dark:text-yellow-400">Examenes Medicos:</strong>
                                                <br>
                                                <span
                                                    class=" @if ($driver->medical_exams < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                    @if (!$driver->medical_exams)
                                                        Sin información
                                                    @else
                                                        {{ $driver->medical_exams }}
                                                    @endif
                                                </span>
                                                ...
                                                <strong class="dark:text-yellow-400">Inducción y
                                                    Reinducción:</strong>
                                                <br>
                                                <span
                                                    class=" @if ($driver->induction < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                    @if (!$driver->induction)
                                                        Sin información
                                                    @else
                                                        {{ $driver->induction }}
                                                ...
                                                <span id="historicos">
                                                    <strong class="dark:text-yellow-400"> Documentos
                                                        Adicionales:</strong>
                                                </span>
                                                <br>
                ...
                <div class="w-9-12 h-4-7 mt-12 mr-4 px-6 py-4  bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg  overflow-x-hidden overflow-y-auto"
                    ...
                    <div class=" p-2 text-justify">
                        ...
                        <div x-data="contexto()">
                            ...
                            <div class="w-80 bg-white p-16 text-center mx-auto  dark:text-white dark:bg-gray-800">
                                    ...
                                    class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"> @endif
                                        ...
                                        <div class="grid grid-cols-5 gap-4">
                                            <div class="border-b text-black text80 dark:text-white "><strong
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','19','')">
                                                        <strong class="dark:text-yellow-400">
                                                            @foreach ($identifitations as $id => $description_identification)
                                                    ...
                                                    <br>
                                                    <button class=""
                                                        onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'19', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                        <span class="hover:bg-blue-700 hover:text-black rounded-3xl p-1">
                                                            {{ $driverSelected->identificationcard }}
                                                        </span>
                                                    </button>
                                            ...
                                            <div class="border-b text-black text80 dark:text-white ">
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','20','')">
                                                        <strong class="dark:text-yellow-400"> Contrato:</strong>
                                                    </button>
                                                    <br>
                                                    <span class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'20', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            @foreach ($bondings as $id => $bonding_type_description)
                                                    ...
                                                    <div class="border-b text-black text80 dark:text-white ">
                                                        @can('listaConductores.actualizarDocumentos')
                                                            ...
                                                            @if ($beneficiaryType[$beneficiary->beneficiaryType - 1] == 'Hijo o Hijastro')
                                                                <span
                                                                    class="hover:bg-blue-700 hover:text-black rounded-3xl p-1">
                                                                    <button class=""
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    ...
                                                    <span
                                                        ...
                                                        <button class=""
                                                            ...
                                                            @if (!$driverSelected->license_expiration)
                                                                Sin información
                                                            @else
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    ...
                                                    <span
                                                        ...
                                                        <button class=""
                                                            ...
                                                            @if (!$driverSelected->certificate_drugs_alchoolemia)
                                                                Sin información
                                                            @else
                                                                {{ $driverSelected->certificate_drugs_alchoolemia }}
                                                            @endif
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    ...
                                                    <span
                                                        ...
                                                        <button class=""
                                                            ...
                                                            @if (!$driverSelected->SIMIT_queries)
                                                                Sin información
                                                            @else
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    ...
                                                    <span
                                                        ...
                                                        <button class=""
                                                            ...
                                                            @if (!$driverSelected->psicosensometrico)
                                                                Sin información
                                                            @else
                                            ...
                                            <div class="border-b text-black text80 dark:text-white">
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','14','')">
                                                        <strong class="dark:text-yellow-400"> Antecedentes
                                                            Contraloria:</strong>
                                                    </button>
                                                    <br>
                                                    <span
                                                        class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 @if ($driverSelected->comptroller_record < $hoy) bg-red-600 text-white @endif ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'14', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            @if (!$driverSelected->comptroller_record)
                                                                Sin información
                                                            @else
                                                                {{ $driverSelected->comptroller_record }}
                                                            @endif
                                                        </button>
                                                    </span>
                                                @else
                                                    ...
                                                    <br>
                                                    <span
                                                        class=" @if ($driverSelected->comptroller_record < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                        @if (!$driverSelected->comptroller_record)
                                                            Sin información
                                                        @else
                                                            {{ $driverSelected->comptroller_record }}
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','15','')">
                                                        <strong class="dark:text-yellow-400"> Antecedentes
                                                            Policia:</strong>
                                                    </button>
                                                    <br>
                                                    <span
                                                        class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 @if ($driverSelected->police_record < $hoy) bg-red-600 text-white @endif ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'15', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            @if (!$driverSelected->police_record)
                                                                Sin información
                                                            @else
                                                                {{ $driverSelected->police_record }}
                                                            @endif
                                                        </button>
                                                    </span>
                                                @else
                                                    ...
                                                    <br>
                                                    <span
                                                        class=" @if ($driverSelected->police_record < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                        @if (!$driverSelected->police_record)
                                                            Sin información
                                                        @else
                                                            {{ $driverSelected->police_record }}
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','16','')">
                                                        <strong class="dark:text-yellow-400"> Antecedentes
                                                            Procuraduria:</strong>
                                                    </button>
                                                    <br>
                                                    <span
                                                        class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 @if ($driverSelected->attorney_record < $hoy) bg-red-600 text-white @endif ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'16', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            @if (!$driverSelected->attorney_record)
                                                                Sin información
                                                            @else
                                                                {{ $driverSelected->attorney_record }}
                                                            @endif
                                                        </button>
                                                    </span>
                                                @else
                                                    ...
                                                    <br>
                                                    <span
                                                        class=" @if ($driverSelected->attorney_record < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                        @if (!$driverSelected->attorney_record)
                                                            Sin información
                                                        @else
                                                            {{ $driverSelected->attorney_record }}
                                            ...
                                            <div class="border-b text-black text80 dark:text-white">
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','17','')">
                                                        <strong class="dark:text-yellow-400"> Examenes
                                                            Medicos:</strong>
                                                    </button>
                                                    <br>
                                                    <span
                                                        class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 @if ($driverSelected->medical_exams < $hoy) bg-red-600 text-white @endif ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'17', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            @if (!$driverSelected->medical_exams)
                                                                Sin información
                                                            @else
                                                                {{ $driverSelected->medical_exams }}
                                                            @endif
                                                        </button>
                                                    </span>
                                                @else
                                                    ...
                                                    <br>
                                                    <span
                                                        class=" @if ($driverSelected->medical_exams < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                        @if (!$driverSelected->medical_exams)
                                                            Sin información
                                                        @else
                                                            {{ $driverSelected->medical_exams }}
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','18','')">
                                                        <strong class="dark:text-yellow-400"> Inducción y
                                                            Reinducción:</strong>
                                                    </button>
                                                    <br>
                                                    <span
                                                        class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 @if ($driverSelected->induction < $hoy) bg-red-600 text-white @endif ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'18', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            @if (!$driverSelected->induction)
                                                                Sin información
                                                            @else
                                                                {{ $driverSelected->induction }}
                                                            @endif
                                                        </button>
                                                    </span>
                                                @else
                                                    ...
                                                    <br>
                                                    <span
                                                        class=" @if ($driverSelected->induction < $hoy) bg-red-600 text-white rounded-3xl p-1 @endif ">
                                                        @if (!$driverSelected->induction)
                                                            Sin información
                                                        @else
                                                            {{ $driverSelected->induction }}
                                                ...
                                                @can('listaConductores.actualizarDocumentos')
                                                    <button id="historicos"
                                                        onclick="historicos('{{ $driverSelected->user_id }}','21','')">
                                                        <strong class="dark:text-yellow-400"> Documentos
                                                            Adicionales:</strong>
                                                    </button>
                                                    <br>
                                                    <span class="hover:bg-blue-700 hover:text-black rounded-3xl p-1 ">
                                                        <button class=""
                                                            onclick="modalDocumentation('{{ $driverSelected->identificationcard }}' ,'21', '{{ $driverSelected->user_id }}',''),viewDate()">
                                                            Adicionar
                                                        </button>
                                                    </span>
                                                @endcan
                                ...
                                <div x-show="activeTab===1">
                                    <svg width="1100" height="636" viewBox="0 0 1100 636" fill="none"
    ...
    <!--Modal Document -->
        ...
        @include('livewire.list.sections.modalDriver-document')

    <!--end Modal Document -->

    <!--Modal historicos -->

    @include('livewire.list.sections.modalDriver-historicos')
