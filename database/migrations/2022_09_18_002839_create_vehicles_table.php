...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('vehicles', function (Blueprint $table) {
			...
			$table->string('card_operation', 120)->nullable();//numero_tarjeta_operacion
			...
			$table->string('service', 60)->nullable();//uso_o_servicio_vehiculo
			...
			$table->enum('type_direction', ['1', '2','3'])->nullable();//tipo_direccion['mecánica','hidráulica','eléctrica']
			...
			$table->enum('front_suspension', ['1', '2','3'])->nullable();//suspensiones_delantera['Suspensión McPherson','Suspensión de doble horquilla','Suspensión de eje rígido']
			$table->enum('rear_suspension', ['1', '2','3'])->nullable();//suspensiones_trasera['Suspensión McPherson','Suspensión de doble horquilla','Suspensión de eje rígido']
